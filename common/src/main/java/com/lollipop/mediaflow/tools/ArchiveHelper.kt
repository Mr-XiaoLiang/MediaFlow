...
object ArchiveHelper {
    ...
    var archiveDialogCallback: ArchiveDialogCallback? = null
    ...
    private fun showArchiveDialog(context: Context, callback: (ArchiveBasket) -> Unit) {
        archiveDialogCallback?.showArchiveDialog(context, callback)
    }

    fun interface ArchiveDialogCallback {
        fun showArchiveDialog(context: Context, callback: (ArchiveBasket) -> Unit)
    }
